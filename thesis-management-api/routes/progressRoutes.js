const progressRoutes = async (req, res, pathParts) => {
  ...
  if (req.method === "GET" && pathParts.length === 2) {
    ...
    const query =
      "SELECT * FROM progress WHERE thesis_id = $1 ORDER BY created_at DESC";
    ...
    const query =
      "INSERT INTO progress (thesis_id, instructor_id, note) VALUES ($1, $2, $3) RETURNING *";
